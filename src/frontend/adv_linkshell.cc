...
int main( int argc, char *argv[] )
{
    try {
        ...
        const option command_line_options[] = {
            ...
            { "downlink-advlog",      required_argument, nullptr, 'r' },
            { "uplink-advlog",        required_argument, nullptr, 's' },
            { 0,                                      0, nullptr, 0 }
        };

        string uplink_logfile, downlink_logfile, downlink_advlogfile, uplink_advlogfile;
        bool repeat = true;
        ...
        while ( true ) {
            ...
            case 'b':
                ...
                break;
            case 'r':
                downlink_advlogfile = optarg;
                break;
            case 's':
                uplink_advlogfile = optarg;
                break;
            case '?':
                usage_error( argv[ 0 ] );
                break;
        ...
        PacketShell<AdvLinkQueue> link_shell_app( "link", user_environment, passthrough_until_signal );

        link_shell_app.start_uplink( "[advlink] ", command,
                                     ...
                                     command_line, uplink_advlogfile );
        ...
        link_shell_app.start_downlink( "Downlink", downlink_filename, downlink_logfile, repeat, meter_downlink, meter_downlink_delay,
                                       ...
                                       command_line, downlink_advlogfile );
